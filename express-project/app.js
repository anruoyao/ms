...
const corsOptions = {
  origin: [
    'http://localhost:5173',
    'http://localhost:3001',
    'https://api.misskey.site',
    'https://misskey.site',
    // 允许所有 Capacitor App 的请求（App 使用 file:// 或 capacitor:// 协议）
    function(origin, callback) {
      // 允许没有 origin 的请求（如 App 内请求）
      ...
      if (allowedOrigins.includes(origin) || origin.startsWith('file://') || origin.startsWith('capacitor://')) {
        callback(null, true);
      } else {
